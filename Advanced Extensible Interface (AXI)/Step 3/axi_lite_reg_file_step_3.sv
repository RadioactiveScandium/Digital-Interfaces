...
// Deltas w.r.t Step 2 :
//
//   * Refactored the logic for write enable signal to the registers 0 and 1
//   * Added support for Fine-Grained Byte-Lane Masking using the Strobe feature
//   * Note the flopped version of strobe is used to avoid "slippage", just like address
//
...
/////////////////   REGISTER WRITES     ///////////////////
///////////////////////////////////////////////////////////
logic [C_S_AXI_DATA_WIDTH:0]       reg_bank0;
logic [C_S_AXI_DATA_WIDTH:0]       reg_bank1;
...
// Writing to the registers if (also strobes, captured later) : 
//    1. State is IDLE 
//    2. All handshakes are done
//    3. Address Matches 
logic reg_bank0_wr_en;
logic reg_bank1_wr_en;
assign reg_bank0_wr_en = ((state == IDLE) && (aw_hs_done_reg && w_hs_done_reg) && reg_bank0_w_addr_match); 
assign reg_bank1_wr_en = ((state == IDLE) && (aw_hs_done_reg && w_hs_done_reg) && reg_bank1_w_addr_match);
